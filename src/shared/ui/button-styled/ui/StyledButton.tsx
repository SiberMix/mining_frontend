...
export const StyledButton = styled(Button)<StyledButtonProps>`
  ...
  border: ${({ border }) => border ? border : '1px solid #858585'};
  ...
  &:hover {
    ...
    border: ${({ hoverborder }) => hoverborder ? hoverborder : '1px solid #858585'} !important; //и тут тоже
    background-color: ${({ hoverbgc }) => hoverbgc ? hoverbgc : '#858585'} !important; //и тут тоже
  }
`
